...
// n must be between 0 and 100
    if (n <= 100)
    {
        printf("Resize value needs to be between 0 and 100\n");
        return 5;
    }
...
// Changes header files horizontally and vertically by n
    biR.biWidth = bi.biWidth * n;
    biR.biHeight = bi.biHeight * n;

// ensure infile is (likely) a 24-bit uncompressed BMP 4.0
// Multiple of 4 makes up for padding
